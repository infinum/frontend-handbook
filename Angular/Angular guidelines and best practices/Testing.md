...
Angular code is organized into modules. As mentioned in [an earlier chapter](/handbook/books/frontend/angular/angular-guidelines-and-best-practices/core-libraries-configuration-and-tools#creating-new-components), we recommend that each component has its own module as it makes dependency management much easier.
...
This is bad because the parent test depends on implementation details of the child component, making the test fragile.
